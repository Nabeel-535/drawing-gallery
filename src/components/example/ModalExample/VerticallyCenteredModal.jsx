  ...
  return (
    <ComponentCard title="Vertically Centered Modal">
      <button
        ...
        className="px-4 py-3 text-sm font-medium text-white rounded-lg bg-primary-500 shadow-theme-xs hover:bg-primary-600"
      >
        Open Modal
      </button>
      <Modal
      ...
      >
        <div className="text-center">
          <div className="relative flex items-center justify-center z-1 mb-7">
            <svg
              className="fill-primary-50 dark:fill-primary-500/15"
              width="90"
              height="90"
              viewBox="0 0 90 90"
              fill="none"
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            <button
              type="button"
              className="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-primary-500 shadow-theme-xs hover:bg-primary-600 sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
